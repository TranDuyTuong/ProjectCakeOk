        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentFile = table.Column<byte[]>(type: "varbinary(4000)", nullable: false),
                    MimeType = table.Column<string>(type: "text", nullable: false),
                    TypeFile = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDPrice = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Price = table.Column<double>(type: "double", nullable: false),
                    PriceDiscount = table.Column<double>(type: "double", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDChange = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    EmailRequest = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    Status = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    NameDiscount = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDLuck = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    NameGift = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    ContentImage = table.Column<byte[]>(type: "varbinary(4000)", nullable: false),
                    MimeType = table.Column<string>(type: "text", nullable: false),
                    NameImage = table.Column<string>(type: "text", nullable: false),
                    TypeFile = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    Status = table.Column<bool>(type: "tinyint(1)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDGift = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    Image = table.Column<byte[]>(type: "varbinary(4000)", nullable: false),
                    NameImage = table.Column<string>(type: "text", nullable: false),
                    MimeType = table.Column<string>(type: "text", nullable: false),
                    TypeFile = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Title = table.Column<string>(type: "nvarchar(150)", maxLength: 200, nullable: false),
                    ContentFile = table.Column<byte[]>(type: "varbinary(4000)", nullable: false),
                    MimeType = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDKindCake = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDRole = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    NameRole = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Symbol = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    Discripttion = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDStaffOrChef = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    Status = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDTypeCake = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    Status = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDPay = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDUrl = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDVocher = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IDCity = table.Column<int>(type: "int", nullable: false),
                    t_CityIDCity = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDAccount = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    PassWord = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    IDCustomerOrStaff = table.Column<int>(type: "int", nullable: false),
                    t_CustomerOrStaffIDCustomerOrStaff = table.Column<int>(type: "int", nullable: true),
                    Id = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDRotation = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    PercentPage = table.Column<double>(type: "double", nullable: false),
                    IDLuck = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_GiftLuckIDLuck = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeFile = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    IDPosition = table.Column<int>(type: "int", nullable: false),
                    t_PositionIDPosition = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDCake = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    NoCake = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false),
                    ...
                    IDKindCake = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_KindCakeIDKindCake = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDStatus = table.Column<int>(type: "int", nullable: false),
                    t_StatusCakeIDStatus = table.Column<int>(type: "int", nullable: true),
                    IDNewCake = table.Column<int>(type: "int", nullable: false),
                    t_NewCakeIDNewCake = table.Column<int>(type: "int", nullable: true),
                    IDPrice = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CakePriceIDPrice = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDTypeCake = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_TypeCakeIDTypeCake = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDDiscount = table.Column<int>(type: "int", nullable: false),
                    t_DiscountCakeIDDiscount = table.Column<int>(type: "int", nullable: true),
                    IDElement = table.Column<int>(type: "int", nullable: false),
                    t_CakeElementIDElement = table.Column<int>(type: "int", nullable: true),
                    IDSmell = table.Column<int>(type: "int", nullable: false),
                    t_SmellCakeIDSmell = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDBrach = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    ...
                    IDRegion = table.Column<int>(type: "int", nullable: false),
                    t_RegionsIDRegion = table.Column<int>(type: "int", nullable: true),
                    IDCity = table.Column<int>(type: "int", nullable: false),
                    t_CityIDCity = table.Column<int>(type: "int", nullable: true),
                    IDDistrict = table.Column<int>(type: "int", nullable: false),
                    t_DistrictIDDistrict = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: false),
                    ContentFile = table.Column<byte[]>(type: "varbinary(4000)", nullable: false),
                    MimeFile = table.Column<string>(type: "text", nullable: false),
                    TypeFile = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
                    ...
                    t_DistrictIDDistrict = table.Column<int>(type: "int", nullable: true),
                    IDGender = table.Column<int>(type: "int", nullable: false),
                    t_GenderIDGender = table.Column<int>(type: "int", nullable: true),
                    IDCountry = table.Column<int>(type: "int", nullable: false),
                    t_CountryIDCountry = table.Column<int>(type: "int", nullable: true),
                    IDCustomerOrStaff = table.Column<int>(type: "int", nullable: false),
                    t_CustomerOrStaffIDCustomerOrStaff = table.Column<int>(type: "int", nullable: true),
                    IDAccount = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_UserIDAccount = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "IDCustomerOrStaff");
                    table.ForeignKey(
                        name: "FK_T_Customers_T_CustomerOrStaffs_t_CustomerOrStaffIDCustomerOr~",
                        column: x => x.t_CustomerOrStaffIDCustomerOrStaff,
                        principalTable: "T_CustomerOrStaffs",
                        principalColumn: "IDCustomerOrStaff",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Phone = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: false),
                    IDCode = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    ContentFile = table.Column<byte[]>(type: "varbinary(4000)", nullable: false),
                    FileName = table.Column<string>(type: "text", nullable: false),
                    TypeImage = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    MimeType = table.Column<string>(type: "text", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    IDMarriage = table.Column<int>(type: "int", nullable: false),
                    t_MarriageIDMarriage = table.Column<int>(type: "int", nullable: true),
                    IDAccount = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_UserIDAccount = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDCustomerOrStaff = table.Column<int>(type: "int", nullable: false),
                    t_CustomerOrStaffIDCustomerOrStaff = table.Column<int>(type: "int", nullable: true),
                    ...
                    t_GenderIDGender = table.Column<int>(type: "int", nullable: true),
                    IDStaffOrChef = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_StaffOrChefIDStaffOrChef = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "IDCustomerOrStaff");
                    table.ForeignKey(
                        name: "FK_T_Staffs_T_CustomerOrStaffs_t_CustomerOrStaffIDCustomerOrSta~",
                        column: x => x.t_CustomerOrStaffIDCustomerOrStaff,
                        principalTable: "T_CustomerOrStaffs",
                        principalColumn: "IDCustomerOrStaff",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    IDCake = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CakeIDCake = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDGift = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_GiftIDGift = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDImage = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDInfomationOrder = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    NameCustomer = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    EmailCustomer = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    PhoneCustomer = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: false),
                    Address = table.Column<string>(type: "nvarchar(250)", maxLength: 100, nullable: false),
                    ExpecteDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    ...
                    t_DistrictIDDistrict = table.Column<int>(type: "int", nullable: true),
                    IDBrach = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_BranchIDBrach = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IDTypeAddress = table.Column<int>(type: "int", nullable: false),
                    t_TypeAddressIDTypeAddress = table.Column<int>(type: "int", nullable: true),
                    IDCity = table.Column<int>(type: "int", nullable: false),
                    t_CityIDCity = table.Column<int>(type: "int", nullable: true),
                    IDDistrict = table.Column<int>(type: "int", nullable: false),
                    t_DistrictIDDistrict = table.Column<int>(type: "int", nullable: true),
                    IDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CustomerIDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_T_AddressUserDefauls_T_TypeAddreses_t_TypeAddressIDTypeAddre~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    t_CustomerIDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDSize = table.Column<int>(type: "int", nullable: false),
                    t_SizeCakeIDSize = table.Column<int>(type: "int", nullable: true),
                    IDStatusIdea = table.Column<int>(type: "int", nullable: false),
                    t_StatusIdeaIDStatusIdea = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDCart = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    Amount = table.Column<int>(type: "int", nullable: false),
                    IDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CustomerIDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdSeach = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusUseVocher = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CustomerIDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDVocher = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_VocherIDVocher = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDChef = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    NoChef = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(250)", nullable: false),
                    Experience = table.Column<int>(type: "int", nullable: false),
                    IDStaff = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_StaffIDStaff = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IDRole = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_RoleIDRole = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDStaff = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_StaffIDStaff = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDOrder = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    UseVocher = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CancelOrder = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    PercentReduction = table.Column<int>(type: "int", nullable: true),
                    IDInfomationOrder = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_InfomationOrderIDInfomationOrder = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CustomerIDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDPay = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_TypePayIDPay = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDStatusOrder = table.Column<int>(type: "int", nullable: false),
                    t_StatusOrderIDStatusOrder = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_T_Orders_T_InfomationOrders_t_InfomationOrderIDInfomationOrd~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDImageCustom = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Name = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    TypeImage = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
                    MimeType = table.Column<string>(type: "text", nullable: false),
                    FileContent = table.Column<byte[]>(type: "varbinary(4000)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    IDIdea = table.Column<int>(type: "int", nullable: false),
                    t_CakeCustomIdeaIDIdea = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "IDIdea");
                    table.ForeignKey(
                        name: "FK_T_NotificationCustomCakes_T_CakeCustomIdeas_t_CakeCustomIdea~",
                        column: x => x.t_CakeCustomIdeaIDIdea,
                        principalTable: "T_CakeCustomIdeas",
                        principalColumn: "IDIdea",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    IDChef = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_ChefIDChef = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDCake = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CakeIDCake = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDCustom = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    NoCustom = table.Column<string>(type: "text", nullable: false),
                    ...
                    t_CustomerIDUser = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDStatus = table.Column<int>(type: "int", nullable: false),
                    t_StatusCustomCakeIDStatus = table.Column<int>(type: "int", nullable: true),
                    IDPay = table.Column<int>(type: "int", nullable: false),
                    t_PayCustomCakeIDPay = table.Column<int>(type: "int", nullable: true),
                    IDIdea = table.Column<int>(type: "int", nullable: false),
                    t_CakeCustomIdeaIDIdea = table.Column<int>(type: "int", nullable: true),
                    IDChef = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_ChefIDChef = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDCancel = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Note = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    IDOrder = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_OrderIDOrder = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDPriceCustom = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Price = table.Column<double>(type: "double", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    IDCustom = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CustomCakeIDCustom = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDBill = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    AmountCake = table.Column<int>(type: "int", nullable: false),
                    TotalPrice = table.Column<double>(type: "double", nullable: false),
                    IDPriceCustom = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CustomCakePriceIDPriceCustom = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDPay = table.Column<int>(type: "int", nullable: false),
                    t_PayCustomCakeIDPay = table.Column<int>(type: "int", nullable: true),
                    IDTypePay = table.Column<int>(type: "int", nullable: false),
                    t_TypePayCustomCakeIDTypePay = table.Column<int>(type: "int", nullable: true),
                    IDCustom = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_CustomCakeIDCustom = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    IDStaff = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    t_StaffIDStaff = table.Column<byte[]>(type: "varbinary(16)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_T_BillCakeCustoms_T_CustomCakePrices_t_CustomCakePriceIDPric~",
                    ...
                    table.ForeignKey(
                        name: "FK_T_BillCakeCustoms_T_TypePayCustomCakes_t_TypePayCustomCakeID~",
